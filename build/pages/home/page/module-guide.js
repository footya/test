...
widget/slide/slide-util
widget/slide/kissy2yui
widget/slide/base
widget/slide/index

*/
KISSY.add('widget/slide/slide-util',function(S){
...
KISSY.add('widget/slide/kissy2yui',function(S){
...
KISSY.add('widget/slide/base',function(S){
...
KISSY.add('widget/slide/index',function(S,BSlide){
...
KISSY.add('page/module-guide', function(S, Node, DOM, UA, Slide, LocalStorage) {
	...
	//fix bug
		...
		$('#J_palyrule').on('click', function() {
			if ( UA.shell.toUpperCase() == 'IE' && UA[UA.shell] < 7 ) {
				location.href = 'http://bbs.taobao.com/catalog/thread/16281010-263749047.htm?spm=0.0.0.0.3gf9a8';
			} else {
				build();
			}
		});

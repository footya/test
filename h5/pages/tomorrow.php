	...
	<section class="round-tab">
		<ul class="tab-list">
			<li id="tab-item-10" class="tab-item tab-item-10" data-tab="10">
				<a href="./index.php#tab10">10:00</a>
				<b class="tab-line"></b>
			</li>
			<li id="tab-item-15" class="tab-item tab-item-15" data-tab="15">
				<a href="./index.php#tab15">15:00</a>
				<b class="tab-line"></b>
			</li>
			<li id="tab-item-20" class="tab-item tab-item-20" data-tab="20">
				<a href="./index.php#tab20">20:00</a>
				<b class="tab-line"></b>
			</li>
			<li id="tab-item-tomorrow" class="tab-item tab-active tab-item-tomorrow" data-tab="tomorrow">
				<a href="./tomorrow.php">明日预告</a>
				<b class="tab-line"></b>
			<li>
		</ul>
	</section>	
	<section id="round-play-wrap" class="round-play">
		<section id="round-tomorrow-10" class="round-tomorrow-goods">
			<p class="status-info status-info-tomorrow">明天10:00开始，六折起降</p>
			<section class="round-goods-wrap"></section>
		</section>
		<section id="round-tomorrow-15" class="round-tomorrow-goods">
			<p class="status-info status-info-tomorrow">明天15:00开始，六折起降</p>
			<section class="round-goods-wrap"></section>
		</section>
		<section id="round-tomorrow-20" class="round-tomorrow-goods">
			<p class="status-info status-info-tomorrow">明天20:00开始，六折起降</p>
			<section class="round-goods-wrap"></section>
		</section>
	</section>
	<section id="tomorrow-footer-tab">
		<a href="./index.php#tab10" class="footer-tab footer-tab-10">10:00点优惠购</a>
		<a href="./index.php#tab15" class="footer-tab footer-tab-15">15:00点优惠购</a>
		<a href="./index.php#tab20" class="footer-tab footer-tab-20">20:00点优惠购</a>
	</section>
</section>
			...
			<li id="item-id-<%=data[i].itemId%>" class="round-goods-item-<%=data[i].tab%> round-goods-item node-watch <%=data[i].currentClass%>" data-tab="<%=data[i].tab%>" data-watch="class:data[<%=i%>].currentClass:state" >
				...
				<div class="img-box">
					<a target="_self" class="img-link" href="http://h5.m.taobao.com/awp/core/detail.htm?id=<%=data[i].itemId%>">
						<img class="item-img" alt="<%=data[i].title%>" data-src="<%=data[i].picUrl%>" src="">
					</a>
